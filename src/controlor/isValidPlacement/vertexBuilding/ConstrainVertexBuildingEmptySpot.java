...
public class ConstrainVertexBuildingEmptySpot extends
		ConstrainVertexBuilding{

	public ConstrainVertexBuildingEmptySpot(Model m) {
		super(m);
	...
	public void isValid(Building b, SettlersVertex position) throws BoardPlacementException{
		...
		if(position.hasBuilding())
			throw new BoardPlacementException("Already occupied");
	}
}
