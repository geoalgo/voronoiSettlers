...
public class ConstrainVertexBuildingRoadAdjacent extends
		ConstrainVertexBuildingDecorator {

	public ConstrainVertexBuildingRoadAdjacent(ConstrainVertexBuilding v) {
		super(v);
	...
	throws BoardPlacementException{
		if(!vertexHasPlayerRoad(position,b.getPlayer()))
			throw new BoardPlacementException("You must build a colony near a road");
		nextTest(b, position);
	}
