...
public class ConstrainVertexBuildingRessource extends ConstrainVertexBuildingDecorator {

	public ConstrainVertexBuildingRessource(ConstrainVertexBuilding v) {
		super(v);
