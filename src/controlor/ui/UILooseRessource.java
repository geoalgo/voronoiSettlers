...
public class UILooseRessource implements ActionListener{
	JFrame frame;
	JPanel panel;
	...
	UILooseRessource(UIControlor uicontrolor,Player p){
	...
	public static void createAndShowGUI(
			UIControlor uicontrolor,
			Player p) {
		UILooseRessource ui = new UILooseRessource(uicontrolor,p);
	}
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == ok){
			...
			if(res.num() == initialRessource.num()/2){
				uicontrolor.looseRessources(res);
